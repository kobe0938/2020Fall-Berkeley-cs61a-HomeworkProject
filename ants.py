...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, beehive):
        ...
        self.distance = 0
        while True:
            if self.prospective_bees_place.bees == []:
                if self.prospective_bees_place.entrance == beehive:
                    return None
                else:
                ...
                if self.min_range <= self.distance <= self.max_range:
                    return rANTdom_else_none(self.prospective_bees_place.bees)
                else:
                    if self.prospective_bees_place.entrance == beehive:
                        return None
                    else:
...
class HungryAnt(Ant):
    ...
    def eat_bee(self, bee):
        # BEGIN Problem 6
        "*** YOUR CODE HERE ***"
        unlucky_bee = rANTdom_else_none(bee)
        if unlucky_bee != None:
            unlucky_bee.reduce_armor(unlucky_bee.armor)
